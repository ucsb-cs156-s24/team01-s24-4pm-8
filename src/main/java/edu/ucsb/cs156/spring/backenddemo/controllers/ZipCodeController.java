...
public class ZipCodeController {
    ...
    @Operation(summary="Get information about a us zipcode", description ="JSON return format documented here: http://api.zippopotam.us/us/{zipcode}")
    @GetMapping("/get")
    public ResponseEntity<String> getZipCodes(
        @Parameter(name="zipcode",description="Zipcode of Santa Barbara",example="93106") @RequestParam String zipcode
